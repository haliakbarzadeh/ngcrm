...
{
    public class CreatePersonCommand : BaseCommandRequest, IRequest<long>
    {
    ...
    public class CreatePersonCommandHandler : IRequestHandler<CreatePersonCommand, long>
    {
        ...
        public CreatePersonCommandHandler(IPersonCommandRepository personCommandRepository)
        {
        ...
        {
            var person = new Person(request.FirstName, request.LastName, request.FatherName, request.CompanyName, request.IsLegal,
