...
{
    public class CreateAccessGroupCommandValidator : AbstractValidator<CreateAccessGroupCommand>
    {
        private readonly IPersonQueryRepository _personQueryRepository;
        public CreateAccessGroupCommandValidator(IPersonQueryRepository personQueryRepository)
        {
            _personQueryRepository = personQueryRepository;
        }

        public override async Task<ValidationResult> ValidateAsync(ValidationContext<CreateAccessGroupCommand> context, CancellationToken cancellation = default)
        {
