...
namespace NgCrm.BasicInfoService.Application.Users.Commands
{
    public class UpdateUserCommandValidator : AbstractValidator<UpdateUserCommand>
    {
        ...
        public override async Task<ValidationResult> ValidateAsync(ValidationContext<UpdateUserCommand> context, CancellationToken cancellation = default)
        {
            RuleFor(x => x.Id).NotEmpty().WithMessage("لطفا شناسه مورد نظر را وارد کنید");
